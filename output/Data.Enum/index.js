...
var enumOrdering = new Enum(function () {
    ...
    throw new Error("Failed pattern match at Data.Enum line 88, column 3 - line 88, column 20: " + [ v.constructor.name ]);
}, function (v) {
    if (v instanceof Data_Ordering.LT) {
        return new Data_Maybe.Just(Data_Ordering.EQ.value);
    };
    ...
    throw new Error("Failed pattern match at Data.Enum line 85, column 3 - line 85, column 20: " + [ v.constructor.name ]);
});
var enumMaybe = function (dictBoundedEnum) {
    return new Enum(function () {
        ...
        throw new Error("Failed pattern match at Data.Enum line 95, column 3 - line 95, column 25: " + [ v.constructor.name ]);
    }, function (v) {
        if (v instanceof Data_Maybe.Nothing) {
        ...
        throw new Error("Failed pattern match at Data.Enum line 93, column 3 - line 93, column 36: " + [ v.constructor.name ]);
    });
};
...
var enumEither = function (dictBoundedEnum) {
    return function (dictBoundedEnum1) {
        return new Enum(function () {
            ...
            throw new Error("Failed pattern match at Data.Enum line 101, column 3 - line 101, column 59: " + [ v.constructor.name ]);
        }, function (v) {
            if (v instanceof Data_Either.Left) {
            ...
            throw new Error("Failed pattern match at Data.Enum line 99, column 3 - line 99, column 71: " + [ v.constructor.name ]);
        });
    };
};
...
var defaultToEnum = function (dictBounded) {
    return function (dictEnum) {
        return function (n) {
            ...
            throw new Error("Failed pattern match at Data.Enum line 252, column 1 - line 255, column 47: " + [ n.constructor.name ]);
        };
    };
};
...
var boundedEnumOrdering = new BoundedEnum(function () {
    ...
    throw new Error("Failed pattern match at Data.Enum line 206, column 3 - line 207, column 3: " + [ v.constructor.name ]);
}, function (v) {
    if (v === 0) {
        return new Data_Maybe.Just(Data_Ordering.LT.value);
    };
...
var boundedEnumMaybe = function (dictBoundedEnum) {
    return new BoundedEnum(function () {
        ...
        throw new Error("Failed pattern match at Data.Enum line 214, column 3 - line 215, column 3: " + [ v.constructor.name ]);
    }, function (v) {
        if (v === 0) {
...
var boundedEnumEither = function (dictBoundedEnum) {
    return function (dictBoundedEnum1) {
        return new BoundedEnum(function () {
            ...
            throw new Error("Failed pattern match at Data.Enum line 228, column 3 - line 228, column 33: " + [ v.constructor.name ]);
        }, function (n) {
            var to = function (v) {
                if (n >= 0 && n < v) {
                ...
                throw new Error("Failed pattern match at Data.Enum line 225, column 5 - line 227, column 46: " + [ v.constructor.name ]);
            };
