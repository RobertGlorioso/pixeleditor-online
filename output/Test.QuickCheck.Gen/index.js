...
var runGen = function ($83) {
    return Control_Monad_State.runState(unGen($83));
};
...
var repeatable = function (f) {
    return Gen(Control_Monad_State_Class.state(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (s) {
        return new Data_Tuple.Tuple(function (a) {
            ...
            $42.newSeed = Test_QuickCheck_LCG.lcgNext(s.newSeed);
            return $42;
        })());
    }));
};
var perturbGen = function (n) {
    return function (gen) {
        return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Data_Identity.monadIdentity))(Control_Monad_State_Class.modify(Control_Monad_State_Trans.monadStateStateT(Data_Identity.monadIdentity))(function (s) {
            ...
            $45.newSeed = Test_QuickCheck_LCG.lcgPerturb(Data_Int.toNumber($foreign.float32ToInt32(n)))(s.newSeed);
            return $45;
        }))(function () {
            return unGen(gen);
        });
...
var frequency = function (v) {
    ...
    var total = Data_Newtype.unwrap(Data_Monoid_Additive.newtypeAdditive)(Data_Foldable.fold(Data_List_Types.foldableList)(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringNumber))(Data_Functor.map(Data_List_Types.functorList)(function ($86) {
        return Data_Monoid_Additive.Additive(Data_Tuple.fst($86));
    })(xxs)));
        ...
        return function ($copy_d) {
            return function ($copy_v1) {
                ...
                function $tco_loop(n, d, v1) {
                    ...
                    throw new Error("Failed pattern match at Test.QuickCheck.Gen line 163, column 23 - line 170, column 23: " + [ n.constructor.name, d.constructor.name, v1.constructor.name ]);
                };
                while (!$tco_done) {
...
var monadGenGen = new Control_Monad_Gen_Class.MonadGen(function () {
    ...
    return function (g) {
        return stateful(function (state) {
            return resize(f(state.size))(g);
        });
    };
}, sized);
