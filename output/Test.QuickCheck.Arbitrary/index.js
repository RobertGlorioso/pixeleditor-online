...
var coarbitraryProduct = function (dictCoarbitrary) {
    return function (dictCoarbitrary1) {
        return new Coarbitrary(function (v) {
            return function ($95) {
                return coarbitrary(dictCoarbitrary1)(v.value1)(coarbitrary(dictCoarbitrary)(v.value0)($95));
            };
        });
    };
};
...
var coarbitrarySum = function (dictCoarbitrary) {
    return function (dictCoarbitrary1) {
        return new Coarbitrary(function (v) {
            ...
            throw new Error("Failed pattern match at Test.QuickCheck.Arbitrary line 185, column 3 - line 185, column 38: " + [ v.constructor.name ]);
        });
    };
};
...
var coarbTuple = function (dictCoarbitrary) {
    return function (dictCoarbitrary1) {
        return new Coarbitrary(function (v) {
            return function ($96) {
                return coarbitrary(dictCoarbitrary1)(v.value1)(coarbitrary(dictCoarbitrary)(v.value0)($96));
            };
        });
    };
};
var coarbOrdering = new Coarbitrary(function (v) {
    ...
    throw new Error("Failed pattern match at Test.QuickCheck.Arbitrary line 95, column 3 - line 96, column 3: " + [ v.constructor.name ]);
});
...
var coarbNonEmpty = function (dictCoarbitrary) {
    return function (dictCoarbitrary1) {
        return new Coarbitrary(function (v) {
            return function ($97) {
                return coarbitrary(dictCoarbitrary)(v.value1)(coarbitrary(dictCoarbitrary1)(v.value0)($97));
            };
        });
    };
};
var coarbMaybe = function (dictCoarbitrary) {
    return new Coarbitrary(function (v) {
        ...
        throw new Error("Failed pattern match at Test.QuickCheck.Arbitrary line 123, column 3 - line 124, column 3: " + [ v.constructor.name ]);
    });
};
var coarbList = function (dictCoarbitrary) {
    return new Coarbitrary(Data_Foldable.foldl(Data_List_Types.foldableList)(function (f) {
        return function (x) {
            return function ($98) {
                return f(coarbitrary(dictCoarbitrary)(x)($98));
            };
        };
...
var coarbInt = new Coarbitrary(function ($99) {
    return Test_QuickCheck_Gen.perturbGen(Data_Int.toNumber($99));
});
...
var coarbEither = function (dictCoarbitrary) {
    return function (dictCoarbitrary1) {
        return new Coarbitrary(function (v) {
            ...
            throw new Error("Failed pattern match at Test.QuickCheck.Arbitrary line 130, column 3 - line 130, column 40: " + [ v.constructor.name ]);
        });
    };
};
...
var coarbBoolean = new Coarbitrary(function (v) {
    ...
    throw new Error("Failed pattern match at Test.QuickCheck.Arbitrary line 58, column 3 - line 59, column 3: " + [ v.constructor.name ]);
});
var coarbArray = function (dictCoarbitrary) {
    return new Coarbitrary(Data_Foldable.foldl(Data_Foldable.foldableArray)(function (f) {
        return function (x) {
            return function ($100) {
                return f(coarbitrary(dictCoarbitrary)(x)($100));
            };
        };
    })(Control_Category.id(Control_Category.categoryFn)));
};
...
var arbitraryLazy = function (dictArbitrary) {
    return new Arbitrary(Control_Bind.bind(Test_QuickCheck_Gen.bindGen)(arbitrary(dictArbitrary))(function ($101) {
        return Control_Applicative.pure(Test_QuickCheck_Gen.applicativeGen)(Data_Lazy.defer(Data_Function["const"]($101)));
    }));
};
